<x-app-layout title="Pet Profile">
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <h3 class="page-title"> Rent Order </h3>
    ...
    <script>
        ...
        let table = $('#tableMerchant').DataTable({
            ...
            width: "100%",
            ajax: {
                url: "{{ route('rent-order.get-rent-order') }}",
                data: function(d) {
                    d.username = username;
                    d.status = status;
                }
            ...
            columns: [{
                ...
                data: 'rent_order_start',
                searchable: false
            }, {
                data: 'rent_order_return',
                searchable: false
            }, {
                data: 'rent_order_duration',
                searchable: false
            }, {
                data: 'rent_order_notes',
                searchable: false
            }, {
                data: 'pet_detail',
                searchable: false
