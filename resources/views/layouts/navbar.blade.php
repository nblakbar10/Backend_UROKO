        ...
        <li class="nav-item dropdown">
          <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
            <div class="navbar-profile">
              <img class="img-xs rounded-circle" src="{{asset('storage/gambar-user/' . Auth::user()->picture)}}" alt="">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item preview-item" href="{{route('admin.create', Auth::user()->id)}}">
              <div class="preview-thumbnail">
                <div class="preview-icon bg-dark rounded-circle">
              ...
              <div class="preview-item-content">
                <p class="preview-subject mb-1">Detail</p>
              </div>
            </a>
            <div class="dropdown-divider"></div>
          ...
          {{-- <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
            ...
            <a class="dropdown-item preview-item">
              ...
              <div class="preview-item-content">
                <a href="{{route('logout')}}" type="submit" class="btn preview-subject mb-1">Profil</a>
              </div>
            </a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item preview-item">
              ...
              <div class="preview-item-content">
                <a href="{{route('logout')}}" type="submit" class="btn preview-subject mb-1">Log out</a>
              </div>
            </a>
          </div> --}}
        </li>
